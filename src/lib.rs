...
///
/// The main feature of this quasirandom implementation is that it can generate
/// up to 32-dimensional values in the form of tuples. For instance, a
/// `Qrng<(f64, f64)>` will generate quasirandom 2-dimensional points.
///
...
mod tests {
    ...
    fn coverage() {
        for &n in &[100, 1_000, 100_000] {
            ...
            for _ in 0..n {
                qrng_set.insert((qrng.next() * n as f64) as u32);
